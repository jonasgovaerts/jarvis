...
func init() {
	...
	utilruntime.Must(jarvisv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.ManagedRepositoryReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "managedrepository")
		os.Exit(1)
	}
